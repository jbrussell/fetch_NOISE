# %% markdown
#
# This version of the code downloads all data within a box defined by [minlatitude, maxlatitude, minlongitude, maxlongitude] for a desired time window and includes desired networks.
#
...
# STATIONS
inventory = client.get_stations(network=','.join(networks), station=stations,channel=','.join(comps), starttime=t1, endtime=t2, minlatitude=minlatitude, maxlatitude=maxlatitude, minlongitude=minlongitude, maxlongitude=maxlongitude)
print(inventory)
